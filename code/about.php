                    ...
                    <div class="page-main-content">
                                ...
                                <div class="banner-header">
                                    <div class="col-lg-5 col-md-offset-7">
                                        <div class="content-inner">
                                            <h2 class="title">
                                                Moorabi's Collection <br/> for you
                                            </h2>
                                            <div class="sub-title">
                                                Shop the latest products right from your home with moorabishop.
                                                We have supplies, clothing & accessories from top brands.
                                            </div>
                                            <a href="#" class="moorabi-button button">Shop now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-4 col-sm-4">
                                <div class="moorabi-iconbox  layout1">
...
?>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     Bibendum commodo                                                                                                                                                                                                                                                                                                                                                                                                                                                                       Home</a>div                                                                                                                         Account</a>div                                                                                            
