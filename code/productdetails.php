...
header("Location: productdetails.php?proid='{$_GET['proid']}'");
                    ...
                    <div class="details-product">
                        <div class="details-thumd">
                            <div class="image-preview-container image-thick-box image_preview_container">
                                <img id="img_zoom" data-zoom-image="<?php echo"admin/{$pro_row['pro_image']}"?>"
                                     src="<?php echo"admin/{$pro_row['pro_image']}"?>"alt="img">
                        ...
                        <div class="details-infor">
                            ...
                            <div id="product-descriptions" class="tab-panel active">
                                <p>
                                <?php echo"{$pro_row['pro_description']}"?>
                                </p>
                                ...
                                <div class="quantity-add-to-cart">
                                    ...
                                    <!-- <button name ="add" class="single_add_to_cart_button button">Add to cart</button> -->
                                    
                                  <?php
                                  
                                  
                                  echo "<a class='single_add_to_cart_button button ' href='productdetails.php?proid={$pro_row['pro_id']}&cartid={$pro_row['pro_id']}' role='button'>Add to Cart</a>"; ?>
                                ...
                                <div class="product-inner equal-element">
                                    ...
                                    <div class="product-thumb">
                                        <div class="thumb-inner">
                                            <a href="#">
                                                <img src="<?php echo"admin/{$rel_row['pro_image']}"?>" alt="img">
                                            </a>
                                    ...
                                    <div class="product-info">
                                        <h5 class="product-name product_title">
                                            <a href="#"><?php echo"{$rel_row['pro_name']}"?></a>
                                        </h5>
                                        <div class="group-info">
